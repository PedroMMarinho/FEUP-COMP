...
public class GrammarTest {
   ...
   /*@Test
    ...
    @Test
    public void testDeclareVariableLength() {
        TestUtils.parseVerbose("int length;",VAR_DECL);
    }
    @Test
    public void testDeclareVariableMain() {
        TestUtils.parseVerbose("int main;",VAR_DECL );
    }
    @Test
    ...
    @Test
    public void testWeirdVarName1(){TestUtils.parseVerbose("_balls",EXPRESSION);}

    @Test
    public void testWeirdVarName2(){TestUtils.parseVerbose("$balls",EXPRESSION);}
